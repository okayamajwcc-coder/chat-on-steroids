...
public static class FocusProbe {
  ...
  public static void Reset() { Calls.Clear(); AttachAllowed=true; ActivationAllowed=true; ThrowActivation=false; Fore=2; Target=3; Arrives=false; FocusChecks=0; }
  ...
  static bool AttachThreadInput(uint from, uint to, bool attach) {
    Calls.Add((attach ? "attach:" : "detach:") + from + "-" + to); return AttachAllowed;
  }
